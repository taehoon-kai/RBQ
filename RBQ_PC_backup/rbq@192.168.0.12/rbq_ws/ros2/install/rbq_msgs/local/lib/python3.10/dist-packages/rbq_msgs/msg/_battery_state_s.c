...
bool rbq_msgs__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rbq_msgs.msg._battery_state.BatteryState", full_classname_dest, 40) == 0);
  }
  rbq_msgs__msg__BatteryState * ros_message = _ros_message;
  {  // header
  ...
  {  // charge_percentage
    ...
    ros_message->charge_percentage = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // current
...
PyObject * rbq_msgs__msg__battery_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rbq_msgs.msg._battery_state");

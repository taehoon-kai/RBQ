...
#ifndef RBQ_MSGS__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
#define RBQ_MSGS__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rbq_msgs__msg__BatteryState __attribute__((deprecated))
#else
# define DEPRECATED__rbq_msgs__msg__BatteryState __declspec(deprecated)
#endif
...
struct BatteryState_
{
  ...
  // pointer types
  using RawPtr =
    rbq_msgs::msg::BatteryState_<ContainerAllocator> *;
  using ConstRawPtr =
    const rbq_msgs::msg::BatteryState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rbq_msgs::msg::BatteryState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rbq_msgs__msg__BatteryState
    std::shared_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rbq_msgs__msg__BatteryState
    std::shared_ptr<rbq_msgs::msg::BatteryState_<ContainerAllocator> const>
...
using BatteryState =
  rbq_msgs::msg::BatteryState_<std::allocator<void>>;
...
#endif  // RBQ_MSGS__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
